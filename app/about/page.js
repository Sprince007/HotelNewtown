    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-gradient-to-r from-cream via-cream-light to-gray-light mt-20">
        <div className="container mx-auto">
          ...
          <div className="bg-white p-10 rounded-lg shadow-2xl flex flex-col md:flex-row mt-10">
            <div className="md:w-2/3">
              ...
              <p className="mb-8 text-lg text-gray-800 leading-relaxed animate-slide-in">
              ...
              <div className="flex items-center mt-10">
                <Image src="/path/to/ceo-image.jpg" alt="John Smith" width={50} height={50} className="rounded-full" />
                <div className="ml-4">
                  <p className="text-lg font-bold text-gray-800">John Smith</p>
                  <p className="text-sm text-orange-600">CEO Newtown</p>
                </div>
                <Image src="/path/to/signature-image.png" alt="Signature" width={100} height={50} className="ml-4" />
              </div>
            </div>
            <div className="md:w-1/3 flex flex-col space-y-4 mt-10 md:mt-0 md:ml-10">
              <Image src="/Image.jpg" alt="Hotel View" width={300} height={200} className="rounded-lg shadow-lg" />
              <Image src="/FormatFactoryIMG_0130.jpg" alt="Happy Customer" width={300} height={200} className="rounded-lg shadow-lg" />
            </div>
          </div>
          <div className="bg-white p-10 rounded-lg shadow-2xl mt-10">
